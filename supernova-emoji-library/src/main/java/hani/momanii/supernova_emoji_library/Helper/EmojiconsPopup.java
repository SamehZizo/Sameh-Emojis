...
public class EmojiconsPopup extends PopupWindow implements ViewPager.OnPageChangeListener, EmojiconRecents {
    ...
    private List<EmojiconGridView> emojiconGridViewList;
    private RecyclerView packagesIconsRecyclerView;
    private List<TabIcon> packagesIcons;
     ...
     */
    public EmojiconsPopup(View rootView, Context mContext, boolean useSystemDefault, List<EmojiPackage> emojiPackages) {
        super(mContext);
        this.mUseSystemDefault = useSystemDefault;
        this.mContext = mContext;
        this.rootView = rootView;
        this.emojiPackages = emojiPackages;
    ...
    private View createCustomView() {
        ...
        // (S) initialize lists
        emojiconGridViewList = new ArrayList<>();
        packagesIcons = new ArrayList<>();
        emojiconGridViewList.add(new EmojiconRecentsGridView(mContext, null, null, this, mUseSystemDefault));
        packagesIcons.add(new TabIcon(R.drawable.selector_emoji_recent));
        for (EmojiPackage emojiPackage : emojiPackages) {
            emojiconGridViewList.add(new EmojiconGridView(mContext, emojiPackage.getEmojicons(), recents, this, mUseSystemDefault));
            packagesIcons.add(new TabIcon(emojiPackage.iconRes));
        }
        mEmojisAdapter = new EmojisPagerAdapter(emojiconGridViewList
                /*Arrays.asList(
        ...
        //mEmojiTabs = new View[packagesIcons.size()];
        ...
        // (S) initialize RecyclerView
        packagesIconsRecyclerView = view.findViewById(R.id.emojis_tab_icons_recycler);
        packagesIconsRecyclerView.setLayoutManager(new LinearLayoutManager(mContext, LinearLayoutManager.HORIZONTAL, false));
        packagesIconsRecyclerView.setAdapter(new EmojisTabIconsAdapter(mContext, packagesIcons, emojisPager, iconPressedColor,
                mEmojiTabLastSelectedIndex, mRecentsManager));
    ...
    public void onPageSelected(int i) {
        //Log.d("Sameh", "page : " + i);
        ((EmojisTabIconsAdapter) packagesIconsRecyclerView.getAdapter()).activePosition(i);
