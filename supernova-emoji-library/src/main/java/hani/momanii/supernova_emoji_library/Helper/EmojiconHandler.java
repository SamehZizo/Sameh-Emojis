...
public final class EmojiconHandler {
    ...
    private static final SparseIntArray sEmojisMap = new SparseIntArray(1030);
    ...
    public static void fillEmojisMap(List<EmojiPackage> emojiPackages) {
        for (EmojiPackage emojiPackage : emojiPackages) {
            for (Emoji emoji : emojiPackage.getICONS()) {
                EmojiconHandler.sEmojisMap.put(emoji.getCode(), emoji.getDrawable());
            }
        }
    }
    ...
    /*static {
        ...
        for (Emoji emoji : emojis) {
            sEmojisMap.put(emoji.getCode(), emoji.getDrawable());
        }
    }*/
            ...
            if (icon == 0) {
                ...
                if (i + skip < textLengthToProcess) {
                    ...
                    if (followUnicode == 0xfe0f) {
                        ...
                        //String resourceName = "emoji_" + hexUnicode;
