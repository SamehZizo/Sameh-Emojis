...
public class EmojIconActions implements View.OnFocusChangeListener {
    ...
    public static List<EmojiPackage> emojiPackages;
     ...
     */
    public EmojIconActions(Context ctx, View rootView, EmojiconEditText emojiconEditText, ImageView emojiButton, List<EmojiPackage> emojiPackages) {
        this.emojiButton = emojiButton;
        this.context = ctx;
        this.rootView = rootView;
        EmojIconActions.emojiPackages = emojiPackages;
        addEmojiconEditTextList(emojiconEditText);
        this.popup = new EmojiconsPopup(rootView, ctx, useSystemEmoji, emojiPackages);
        initListeners();
    }
     ...
     * @param emojiconEditText The Id of EditText.
     */
    public EmojIconActions(Context ctx, View rootView, EmojiconEditText emojiconEditText, List<EmojiPackage> emojiPackages) {
        addEmojiconEditTextList(emojiconEditText);
        this.context = ctx;
        this.rootView = rootView;
        this.popup = new EmojiconsPopup(rootView, ctx, useSystemEmoji, emojiPackages);
